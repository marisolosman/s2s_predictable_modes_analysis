...
np.savez('./outputs/pss_exp_var_w3.npz', models_var_sorted, obs_var, np.sqrt(pss_sorted))
...
np.savez('./outputs/EOF_analsys_w3.npz',obs_pc_w3=obs_pc,obs_evec_w3=obs_evec,
         models_pc_w3=models_pc_sorted, models_evec_w3=models_evec_sorted, dx=dx,
         dy=dy)
...
#Todos tienen 3 modos predictibles
# In[11]:
...
np.savez('./outputs/skill_predic_w3.npz', R_forec_predic_modes, R_forec_residual_modes,
