...
RUTA_OUT = '/home/osman/datos/s2s_predictable_modes_figures/'
...
for i in np.arange(1,5):
    ...
    ax.axhline(y=0,xmin=0,linestyle='--',linewidth=1.2, color='b', alpha=0.5)
    ax.plot(lags, signif, linestyle='--', linewidth=1.2, color='b', alpha=0.5)
    ax.plot(lags, -signif, linestyle='--', linewidth=1.2, color='b', alpha=0.5)
    # tidy up the figure
    ax.set_xlim((0,11))
    ax.set_ylim((-0.5,0.5))
    plt.title('Lagged correlation btw PC1 and PC2',fontsize=12)
    ...
    ax.set_xlim((0,11))
    ax.set_ylim((-0.5,0.5))
    plt.title('Lagged correlation btw PC1 and PC3',fontsize=12)
    ...
    ax.set_xlim((0,11))
    ax.set_ylim((-0.5,0.5))
    plt.title('Lagged correlation btw PC1 and PC4',fontsize=12)
    fig.savefig('/datos/osman/s2s_predictable_modes_figures/PC1_laggedcorrelation_week' + str(i) + '.png',
                dpi=500, bbox_inches='tight', papertype='A4', orientation='landscape')
    ...
    ax.set_xlim((0, 11))
    ax.set_ylim((-0.5, 0.5))
    plt.title('Lagged correlation btw PC2 and PC3', fontsize=12)
    ax = plt.subplot(3, 1, 2)
    ...
    ax.set_xlim((0, 11))
    ax.set_ylim((-0.5, 0.5))
    plt.title('Lagged correlation btw PC2 and PC4', fontsize=12)
    ...
    ax.set_xlim((0, 11))
    ax.set_ylim((-0.5, 0.5))
    plt.title('Lagged correlation btw PC3 and PC4', fontsize=12)
    fig.savefig('/datos/osman/s2s_predictable_modes_figures/PC2_laggedcorrelation_week' + str (i) +
                '.png', dpi=500, bbox_inches='tight', papertype='A4', orientation='landscape')
